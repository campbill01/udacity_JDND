...
public class CarControllerTest {
    ...
    public void listCars() throws Exception {
        ...
        .andExpect(jsonPath("$._embedded.carList[0].id").value(carId));
    }
    ...
    public void findCar() throws Exception {
        Car car = getCar();
        Long carId = car.getId();
        String testString = "{'id':" + carId + "}";
        mvc.perform(get("/cars/" + carId)).andExpect(status().isOk()).andExpect(content().json(testString));
    }
